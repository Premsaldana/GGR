...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://goagardenresort.vercel.app/og-image.jpg", width: 1200, height: 630, alt: "Goa Garden Resort — Private Pool Villa in Colva, Goa" }],
    locale: "en_IN",
  },
  twitter: {
    card: "summary_large_image",
    images: ["https://goagardenresort.vercel.app/og-image.jpg"],
  },
  robots: {
    index: true,
    follow: true,
