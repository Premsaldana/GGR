    ...
    <div className="space-y-6">
      ...
      <div className="mt-8 flex justify-center p-12 bg-white/50 border border-dashed border-[var(--color-admin-mist)] rounded-xl">
        <div className="text-center">
          ...
          <Link href="/admin/calendar" className="inline-block bg-[var(--color-admin-terracotta)] text-[var(--color-admin-shell)] px-6 py-2 rounded-md font-medium text-sm hover:bg-orange-700 transition">Open Calendar</Link>
        </div>
      </div>
    </div>
  );
