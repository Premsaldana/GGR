...
export default function PricingEditor() {
  ...
  return <div className="pricing-editor space-y-6">
    ...
    <section className="pricing-range-card rounded-xl border border-[var(--color-admin-mist)] bg-white p-5 shadow-sm">
